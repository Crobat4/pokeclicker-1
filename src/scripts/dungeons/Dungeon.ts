...
dungeonList['Valley Windworks'] = new Dungeon('Valley Windworks',
    ...
    [
        ...
        new DungeonBossPokemon('Pachirisu', 3803000, 14, {hide: true, requirement: new ClearDungeonRequirement(1, GameConstants.getDungeonIndex('Valley Windworks'))}), // Crobat Fork
    ],
    43000, 204);
...
dungeonList['Mount Lanakila'] = new Dungeon('Mount Lanakila',
    ...
    [
        ...
        new DungeonBossPokemon('Necrozma', 83527125, 65, {weight: 2.75, requirement: new MultiRequirement([
