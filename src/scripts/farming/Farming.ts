...
class Farming implements Feature {
    ...
    initialize(): void {
        ...
        this.berryData[BerryType.Cheri]     = new Berry(BerryType.Cheri,    [5,10,20,30,60],
            ...
            ['This bright red Berry is very spicy and has a provocative flavor. It blooms with delicate, pretty flowers.'], undefined,
            ['Oricorio (Baile)']);
        this.berryData[BerryType.Chesto]    = new Berry(BerryType.Chesto,   [5, 15, 25, 40, 80],
            3, 0.5, 6, 2,
            [0, 10, 0, 0, 0], BerryColor.Purple,
            ['This Berry\'s thick skin and fruit are very tough and dry-tasting. However, every bit of it can be eaten.'], undefined,
            ['Oricorio (Sensu)']);
        this.berryData[BerryType.Pecha]     = new Berry(BerryType.Pecha,    [10, 35, 50, 60, 120],
            4, 0.5, 7, 3,
            [0, 0, 10, 0, 0], BerryColor.Pink,
            ['Because of its hollow inside pocket, there isn\'t a lot to eat. What can be eaten is very sweet and delicious.'], undefined,
            ['Oricorio (Pa\'u)']);
        ...
        this.berryData[BerryType.Aspear]    = new Berry(BerryType.Aspear,   [10, 40, 60, 120, 240],
            ...
            ['This Berry\'s peel is hard, but the flesh inside is very juicy. It is distinguished by its bracing sourness.'], undefined,
            ['Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        this.berryData[BerryType.Leppa]     = new Berry(BerryType.Leppa,    [100, 120, 140, 240, 480],
            7, 0.5, 10, 6,
            [10, 0, 10, 10, 10], BerryColor.Red,
            ['It takes longer to grow than Berries such as Cheri. The smaller Berries taste better.'], undefined,
            ['Oricorio (Baile)']);
        this.berryData[BerryType.Oran]      = new Berry(BerryType.Oran,     [120, 180, 240, 300, 600],
            8, 0.5, 20, 7,
            [10, 10, 0, 10, 10], BerryColor.Blue,
            ['Nature\'s gifts came together as one in this Berry. It has a wondrous mix of flavors that spread in the mouth.'], undefined,
            ['Flabébé (Blue)']);
        ...
        this.berryData[BerryType.Persim]    = new Berry(BerryType.Persim,   [20, 40, 50, 90, 180],
            ...
            ['The more this Berry absorbs energy from sunlight, the more vividly colorful it grows.'], undefined,
            ['Oricorio (Pa\'u)']);
        this.berryData[BerryType.Razz]      = new Berry(BerryType.Razz,     [100, 150, 200, 250, 500],
            7, 0.4, 15, 2,
            [10, 10, 0, 0, 0], BerryColor.Red,
            ['A small hint of spiciness lingers in the red granules surrounding this Berry. Their centers have a dry taste.'], undefined,
            ['Oricorio (Baile)']);
        this.berryData[BerryType.Bluk]      = new Berry(BerryType.Bluk,     [200, 250, 300, 330, 660],
            9, 0.4, 20, 2,
            [0, 10, 10, 0, 0], BerryColor.Purple,
            ['Though this small, delicately-skinned Berry is blue in color, it dyes the mouth black when eaten.'], undefined,
            ['Oricorio (Sensu)']);
        this.berryData[BerryType.Nanab]     = new Berry(BerryType.Nanab,    [25, 30, 35, 250, 500],
            11, 0.4, 25, 2,
            [0, 0, 10, 10, 0], BerryColor.Pink,
            ['Bitter, but with a trace of sweetness, the Nanab Berry was the seventh to be discovered in the world.'], undefined,
            ['Oricorio (Pa\'u)']);
        ...
        this.berryData[BerryType.Pinap]     = new Berry(BerryType.Pinap,    [30, 60, 180, 240, 480],
            ...
            ['It is said that when the sour skin is peeled, this spicy Berry can be crushed to make medicine.'], undefined,
            ['Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);

        this.berryData[BerryType.Figy]      = new Berry(BerryType.Figy,     [40, 160, 230, 350, 700],
            14, 0.3, 40, 3,
            [15, 0, 0, 0, 0], BerryColor.Red,
            ['This Berry is oddly shaped, appearing as if someone took a bite out of it. It is packed full of spicy substances.'], undefined,
            ['Oricorio (Baile)']);
        this.berryData[BerryType.Wiki]      = new Berry(BerryType.Wiki,     [40, 190, 210, 360, 720],
            15, 0.3, 45, 3,
            [0, 15, 0, 0, 0], BerryColor.Purple,
            ['It is said that this Berry grew lumps to help Pokémon grip it, allowing propagation farther afield.'], undefined,
            ['Oricorio (Sensu)']);
        this.berryData[BerryType.Mago]      = new Berry(BerryType.Mago,     [40, 180, 240, 370, 740],
            16, 0.3, 50, 3,
            [0, 0, 15, 0, 0], BerryColor.Pink,
            ['This Berry progressively curves as it grows. The curvier the Berry, the sweeter and tastier.'], undefined,
            ['Oricorio (Pa\'u)']);
        ...
        this.berryData[BerryType.Iapapa]    = new Berry(BerryType.Iapapa,   [40, 200, 230, 380, 760],
            ...
            ['This Berry is very big and sour. The juiciness of the pulp accentuates the sourness.'], undefined,
            ['Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        ...
        this.berryData[BerryType.Pomeg]     = new Berry(BerryType.Pomeg,    [200, 1200, 4000, 5400, 10800],
            ...
            ['When this sweetly spicy Berry\'s thick skin is peeled, many pieces of the fruit spill out.'], undefined,
            ['Oricorio (Baile)']);
        this.berryData[BerryType.Kelpsy]    = new Berry(BerryType.Kelpsy,   [240, 2000, 3400, 6000, 12000],
            21, 0.2, 525, 10,
            [0, 10, 0, 10, 10], BerryColor.Blue,
            ['This Berry can be eaten as is or boiled to obtain an extract that adds a dash of flavor to food.'], undefined,
            ['Flabébé (Blue)']);
        this.berryData[BerryType.Qualot]    = new Berry(BerryType.Qualot,   [230, 1000, 2500, 4800, 9600],
            22, 0.2, 550, 10,
            [10, 0, 10, 0, 10], BerryColor.Pink,
            ['Even in places of constant rain and high humidity, this Berry\'s plant grows healthy and strong.'], undefined,
            ['Oricorio (Pa\'u)']);
        ...
        this.berryData[BerryType.Grepa]     = new Berry(BerryType.Grepa,    [300, 3400, 5600, 7200, 14400],
            ...
            ['One bite of this very tender Berry fills the mouth with its sweet and tangy flavor.'], undefined,
            ['Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        this.berryData[BerryType.Tamato]    = new Berry(BerryType.Tamato,   [430, 1400, 4000, 8640, 17280],
            25, 0.2, 625, 10,
            [20, 10, 0, 0, 0], BerryColor.Red,
            ['This Berry is large and spicy. When eaten during the cold season, it warms the body from inside.'], undefined,
            ['Oricorio (Baile)']);

        this.berryData[BerryType.Cornn]     = new Berry(BerryType.Cornn,    [1100, 4000, 8000, 9000, 18000],
            26, 0.1, 700, 10,
            [0, 20, 10, 0, 0], BerryColor.Purple,
            ['Its dryness is quite strong. As a result, its true deliciousness can\'t be appreciated by just eating one or two.'], undefined,
            ['Oricorio (Sensu)']);
        this.berryData[BerryType.Magost]    = new Berry(BerryType.Magost,   [2400, 6500, 10000, 14400, 28800],
            27, 0.1, 750, 10,
            [0, 0, 20, 10, 0], BerryColor.Pink,
            ['The grown-up flavor and dreamy sweetness of this Berry make it a favorite of Pokémon everywhere.'], undefined,
            ['Oricorio (Pa\'u)']);
        ...
        this.berryData[BerryType.Nomel]     = new Berry(BerryType.Nomel,    [1240, 5200, 10500, 15120, 30240],
            ...
            ['This Berry is quite sour overall, with the sourness especially concentrated at the pointed end.'], undefined,
            ['Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        this.berryData[BerryType.Spelon]    = new Berry(BerryType.Spelon,   [2000, 7000, 12000, 15480, 30960],
            30, 0.1, 900, 10,
            [30, 10, 0, 0, 0], BerryColor.Red,
            ['So spicy is the Spelon Berry that, Fire type or not, Pokémon will try to breathe fire after eating a single one.'], undefined,
            ['Oricorio (Baile)']);
        ...
        this.berryData[BerryType.Watmel]    = new Berry(BerryType.Watmel,   [2300, 3400, 9800, 16560, 33120],
            ...
            ['A bounty of nature that is exceedingly sweet. The Berry is huge, with some discovered that exceed 20 inches.'], undefined,
            ['Oricorio (Pa\'u)']);
        ...
        this.berryData[BerryType.Occa]      = new Berry(BerryType.Occa,     [8090, 13200, 16000, 21960, 43920],
            ...
            ['Charmander', 'Cyndaquil', 'Torchic', 'Chimchar', 'Tepig', 'Fennekin', 'Litten', 'Oricorio (Baile)', 'Scorbunny']);
        this.berryData[BerryType.Passho]    = new Berry(BerryType.Passho,   [490, 3600, 10800, 21600, 43200],
            ...
            ['Squirtle', 'Totodile', 'Mudkip', 'Piplup', 'Oshawott', 'Froakie', 'Popplio', 'Sobble', 'Flabébé (Blue)']);
        ...
        this.berryData[BerryType.Shuca]     = new Berry(BerryType.Shuca,    [7200, 16200, 32400, 39600, 79200],
            ...
            ['Larvitar', 'Flabébé (Yellow)', 'Oricorio (Pom-Pom)']);
        ...
        this.berryData[BerryType.Custap]    = new Berry(BerryType.Custap,   [3240, 8280, 13320, 27360, 54720],
            ...
            ['The flesh underneath the Custap Berry\'s tough skin is sweet and creamy soft.'], undefined,
            ['Oricorio (Baile)']);
        ...
        this.berryData[BerryType.Lansat]    = new Berry(BerryType.Lansat,   [10800, 21600, 43200, 86400, 432000],
            ...
            ['This is said to be a legendary Berry. Holding it supposedly brings great joy.'], undefined,
            ['Oricorio (Baile)']);
