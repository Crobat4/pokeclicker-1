...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        special:
      [
          new SpecialRoutePokemon(['Krabby', 'Wooper', 'Wingull', 'Bounsweet', 'Purrloin', 'Tympole', 'Frillish', 'Kingler', 'Quagsire', 'Pelipper', 'Cloyster', 'Lapras', 'Seaking', 'Grapploct'], new WeatherRequirement([WeatherType.Clear])),
          new SpecialRoutePokemon(['Krabby', 'Wooper', 'Tyrogue', 'Pancham', 'Lotad', 'Seedot', 'Budew', 'Purrloin', 'Tympole', 'Frillish', 'Palpitoad', 'Quagsire', 'Pelipper', 'Jellicent', 'Seaking', 'Grapploct'], new WeatherRequirement([WeatherType.Overcast])),
          ...
          new SpecialRoutePokemon(['Delibird', 'Wingull', 'Snorunt', 'Vanillite', 'Purrloin', 'Tympole', 'Shellder', 'Frillish', 'Palpitoad', 'Diggersby', 'Vanilluxe', 'Lapras', 'Grapploct'], new WeatherRequirement([WeatherType.Snow])),
          new SpecialRoutePokemon(['Delibird', 'Vanillite', 'Klink', 'Bunnelby', 'Krabby', 'Tympole', 'Frillish', 'Palpitoad', 'Vanilluxe', 'Lapras', 'Grapploct'], new WeatherRequirement([WeatherType.Blizzard])),
          ...
          new SpecialRoutePokemon(['Krabby', 'Natu', 'Wingull', 'Ralts', 'Wooper', 'Purrloin', 'Tympole', 'Frillish', 'Palpitoad', 'Quagsire', 'Jellicent', 'Cloyster', 'Lapras', 'Grapploct'], new WeatherRequirement([WeatherType.Fog])),
      ],
    }),
    [new RouteKillRequirement(10, GameConstants.Region.galar, 3)],
    undefined,
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Yamper', 'Skorupi', 'Mareanie', 'Chewtle', 'Shellos (East)', 'Wimpod', 'Boltund', 'Snorlax', 'Drapion', 'Conkeldurr', 'Toxel'], new WeatherRequirement([WeatherType.Thunderstorm])),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        special:
      [
          new SpecialRoutePokemon(['Cutiefly', 'Wobbuffet', 'Liepard', 'Togepi', 'Ribombee', 'Golisopod', 'Bewear', 'Seismitoad', 'Beheeyem', 'Noivern', 'Gallade', 'Seaking', 'Cufant', 'Toxel'], new WeatherRequirement([WeatherType.Clear])),
          ...
          new SpecialRoutePokemon(['Stufful', 'Cramorant (Gulping)', 'Bronzor', 'Binacle', 'Shellos (East)', 'Wimpod', 'Golisopod', 'Bewear', 'Seismitoad', 'Bronzong', 'Noivern', 'Gallade', 'Jellicent', 'Toxel'], new WeatherRequirement([WeatherType.Rain])),
          new SpecialRoutePokemon(['Stufful', 'Frillish', 'Bronzor', 'Binacle', 'Shellos (East)', 'Bewear', 'Golisopod', 'Seismitoad', 'Bronzong', 'Noivern', 'Gallade', 'Toxel'], new WeatherRequirement([WeatherType.Thunderstorm])),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Yamper', 'Dewpider', 'Pikachu', 'Bronzor', 'Gurdurr', 'Boldore', 'Impidimp', 'Applin', 'Bronzong', 'Araquanid', 'Toxel'], new WeatherRequirement([WeatherType.Thunderstorm])),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Garbodor', 'Drapion', 'Galarian Weezing', 'Hitmontop', 'Skuntank', 'Grimmsnarl', 'Pangoro', 'Falinks', 'Jangmo-o', 'Espeon', 'Shiinotic', 'Seaking', 'Jellicent', 'Dreepy', 'Drakloak'], new WeatherRequirement([WeatherType.Overcast])),
          new SpecialRoutePokemon(['Seismitoad', 'Araquanid', 'Golisopod', 'Rotom', 'Pelipper', 'Cramorant (Gulping)', 'Quagsire', 'Barbaracle', 'Deino', 'Goomy', 'Vaporeon', 'Shiinotic', 'Lapras', 'Jellicent', 'Drakloak'], new WeatherRequirement([WeatherType.Rain])),
          new SpecialRoutePokemon(['Galvantula', 'Noivern', 'Haxorus', 'Morpeko', 'Rotom', 'Boltund', 'Jellicent', 'Zweilous', 'Drampa', 'Sliggoo', 'Hakamo-o', 'Jolteon', 'Gardevoir', 'Shiinotic', 'Seaking', 'Lapras', 'Jellicent', 'Dreepy', 'Drakloak'], new WeatherRequirement([WeatherType.Thunderstorm])),
          ...
          new SpecialRoutePokemon(['Wobbuffet', 'Gothitelle', 'Reuniclus', 'Claydol', 'Bronzong', 'Gardevoir', 'Sylveon', 'Milotic', 'Lapras', 'Seaking', 'Dreepy', 'Drakloak'], new WeatherRequirement([WeatherType.Fog])),
      ],
    }),
    [
        new MultiRequirement([
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Karrablast', 'Shelmet', 'Espurr', 'Charjabug', 'Machoke', 'Wobbuffet', 'Wimpod', 'Vileplume', 'Klinklang', 'Toxel'], new WeatherRequirement([WeatherType.Thunderstorm])),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
        ...
        headbutt: ['Greedent'],
        eggExclusive: ['Clobbopus', 'Grapploct'],
    }),
