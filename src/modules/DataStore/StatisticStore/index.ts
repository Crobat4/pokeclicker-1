...
export default class Statistics implements Saveable {
    ...
    selectedRoute = ko.observable({ name: '', pokemonList: [], region: -1 });
    ...
    totalShadowGenderlessPokemonEncountered: KnockoutObservable<number>;
    // Underground
    ...
    shadowPokemonEncountered: PokemonStats;
    ...
    shadowMalePokemonEncountered: PokemonStats;
    shadowFemalePokemonEncountered: PokemonStats;
