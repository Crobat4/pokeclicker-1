    ...
    initialize(): void {
        this.itemList = [
            ...
            new KeyItem(KeyItemType.Mystery_egg, 'A mysterious Egg obtained from Mr. Pokémon. This allows you to use the Pokémon Day Care to help improve your Pokémon Attack. Some baby Pokémon can only be found through breeding, too!',
                () => App.game.challenges.list.monotype.active() ? App.game.statistics.dungeonsCleared[getDungeonIndex('Viridian Forest')]() >= 1 : App.game.statistics.routeKills[Region.kanto][5]() >= ROUTE_KILLS_NEEDED, undefined, undefined, 'Mystery Egg'),
