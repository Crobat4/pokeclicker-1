...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Grapploct'], new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Sunny, WeatherType.Sandstorm, WeatherType.Fog])),
      ],
    }),
    [new RouteKillRequirement(10, Region.galar, 3)],
    undefined,
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Grapploct'], new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Sunny, WeatherType.Fog])),
      ],
        headbutt: ['Skwovet', 'Applin'],
    }),
    [
