...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        special: [
            new SpecialRoutePokemon(['Houndour'], new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion)),
            new SpecialRoutePokemon(['Murkrow'], new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion)),
        ],
    }),
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        special: [
            new SpecialRoutePokemon(['Slugma'], new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion)),
            new SpecialRoutePokemon(['Murkrow'], new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion)),
        ],
    }),
    [
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        special: [new SpecialRoutePokemon(['Slugma'], new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion))],
    }),
    [
        new OneFromManyRequirement([
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
        ...
        eggExclusive: ['Zebstrika', 'Blitzle'],
        /*
        special:
        [
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Grapploct'], new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog])),
      ],
    }),
    [new RouteKillRequirement(10, Region.galar, 3)],
    undefined,
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Dreepy'], new WeatherRequirement([WeatherType.Overcast, WeatherType.Thunderstorm, WeatherType.Fog])),
          new SpecialRoutePokemon(['Drakloak'], new WeatherRequirement([WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Fog])),
      ],
    }),
    [
        new MultiRequirement([
...
Routes.add(new RegionRoute(
    ...
    new RoutePokemon({
      ...
      [
          ...
          new SpecialRoutePokemon(['Grapploct'], new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Harsh_Sunlight, WeatherType.Fog])),
      ],
        headbutt: ['Skwovet', 'Applin'],
    }),
    [
